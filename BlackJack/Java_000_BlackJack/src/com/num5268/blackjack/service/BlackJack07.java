...
public class BlackJack07 {
	...
	// 각 플레이어(딜러포함)가 받은 카드를 저장할 List
		...
		public BlackJack07(List<DeckVO> deckList) {
			this(deckList,"딜러");
		}
		
		// 플레이어로 사용하는 경우 이 생성자를 호출
		public BlackJack07(List<DeckVO> deckList, String playName) {
		...
		public void playGame() {
			...
			BlackJack07 딜러 = new BlackJack07(deckList);
			BlackJack07 게이머 = new BlackJack07(deckList, "게이머");
